...
int onemklZrot(syclQueue_t device_queue, int64_t n, double _Complex *x, int64_t incx, double _Complex
               *y, int64_t incy, double c, double s);
...
int onemklSCscal(syclQueue_t device_queue, int64_t n, float alpha, float _Complex *x, int64_t incx);

int onemklDZscal(syclQueue_t device_queue, int64_t n, double alpha, double _Complex *x, int64_t incx);
...
void onemklZpotrs_batch(syclQueue_t device_queue, onemklUplo uplo, int64_t n, int64_t nrhs, double
                        ...
                        int64_t stride_b, int64_t batch_size, double _Complex *scratchpad,
                        int64_t scratchpad_size);
