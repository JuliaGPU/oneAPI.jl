...
function onemklHaxpy(device_queue, n, alpha, x, incx, y, incy)
    @ccall liboneapi_support.onemklHaxpy(device_queue::syclQueue_t, n::Int64,
                                         ...
                                         y::ZePtr{Float16}, incy::Int64)::Cint
end
...
function onemklCdgmm(device_queue, left_right, m, n, a, lda, x, incx, c, ldc)
    @ccall liboneapi_support.onemklCdgmm(device_queue::syclQueue_t, left_right::onemklSide,
                                         m::Int64, n::Int64, a::Ptr{ComplexF32}, lda::Int64,
...
function onemklCgeru(device_queue, m, n, alpha, x, incx, y, incy, a, lda)
    @ccall liboneapi_support.onemklCgeru(device_queue::syclQueue_t, m::Int64, n::Int64,
                                         alpha::ComplexF32, x::Ptr{ComplexF32}, incx::Int64,
...
function onemklSsymv(device_queue, upper_lower, n, alpha, a, lda, x, incx, beta, y, incy)
    @ccall liboneapi_support.onemklSsymv(device_queue::syclQueue_t, upper_lower::onemklUplo,
                                         ...
                                         beta::Cfloat, y::ZePtr{Cfloat}, incy::Int64)::Cint
end
...
function onemklCgebrd(device_queue, m, n, a, lda, d, e, tauq, taup, scratchpad,
    ...
    @ccall liboneapi_support.onemklCgebrd(device_queue::syclQueue_t, m::Int64, n::Int64,
                                          a::Ptr{ComplexF32}, lda::Int64, d::Ptr{Cfloat},
                                          e::Ptr{Cfloat}, tauq::Ptr{ComplexF32},
                                          taup::Ptr{ComplexF32},
                                          scratchpad::Ptr{ComplexF32},
                                          scratchpad_size::Int64)::Cint
end
...
function onemklDgebrd(device_queue, m, n, a, lda, d, e, tauq, taup, scratchpad,
    ...
    @ccall liboneapi_support.onemklDgebrd(device_queue::syclQueue_t, m::Int64, n::Int64,
                                          a::Ptr{Cdouble}, lda::Int64, d::Ptr{Cdouble},
                                          e::Ptr{Cdouble}, tauq::Ptr{Cdouble},
                                          taup::Ptr{Cdouble}, scratchpad::Ptr{Cdouble},
                                          scratchpad_size::Int64)::Cint
end
...
function onemklSgebrd(device_queue, m, n, a, lda, d, e, tauq, taup, scratchpad,
    ...
    @ccall liboneapi_support.onemklSgebrd(device_queue::syclQueue_t, m::Int64, n::Int64,
                                          a::Ptr{Cfloat}, lda::Int64, d::Ptr{Cfloat},
                                          e::Ptr{Cfloat}, tauq::Ptr{Cfloat},
                                          taup::Ptr{Cfloat}, scratchpad::Ptr{Cfloat},
                                          scratchpad_size::Int64)::Cint
end
...
function onemklZgebrd(device_queue, m, n, a, lda, d, e, tauq, taup, scratchpad,
    ...
    @ccall liboneapi_support.onemklZgebrd(device_queue::syclQueue_t, m::Int64, n::Int64,
                                          a::Ptr{ComplexF32}, lda::Int64, d::Ptr{Cdouble},
                                          e::Ptr{Cdouble}, tauq::Ptr{ComplexF32},
                                          taup::Ptr{ComplexF32},
                                          scratchpad::Ptr{ComplexF32},
                                          scratchpad_size::Int64)::Cint
end
...
function onemklCgesvd(device_queue, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt,
    ...
    @ccall liboneapi_support.onemklCgesvd(device_queue::syclQueue_t, jobu::onemklJobsvd,
                                          ...
                                          a::Ptr{ComplexF32}, lda::Int64, s::Ptr{Cfloat},
...
function onemklZgesvd(device_queue, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt,
    ...
    @ccall liboneapi_support.onemklZgesvd(device_queue::syclQueue_t, jobu::onemklJobsvd,
                                          jobvt::onemklJobsvd, m::Int64, n::Int64,
                                          a::Ptr{ComplexF32}, lda::Int64, s::Ptr{Cdouble},
                                          u::Ptr{ComplexF32}, ldu::Int64,
                                          vt::Ptr{ComplexF32}, ldvt::Int64,
                                          scratchpad::Ptr{ComplexF32},
                                          scratchpad_size::Int64)::Cint
...
function onemklDgesvd(device_queue, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt,
    ...
    @ccall liboneapi_support.onemklDgesvd(device_queue::syclQueue_t, jobu::onemklJobsvd,
                                          jobvt::onemklJobsvd, m::Int64, n::Int64,
                                          a::Ptr{Cdouble}, lda::Int64, s::Ptr{Cdouble},
                                          u::Ptr{Cdouble}, ldu::Int64, vt::Ptr{Cdouble},
                                          ldvt::Int64, scratchpad::Ptr{Cdouble},
                                          scratchpad_size::Int64)::Cint
end
...
function onemklSgesvd(device_queue, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt,
    ...
    @ccall liboneapi_support.onemklSgesvd(device_queue::syclQueue_t, jobu::onemklJobsvd,
                                          jobvt::onemklJobsvd, m::Int64, n::Int64,
                                          a::Ptr{Cfloat}, lda::Int64, s::Ptr{Cfloat},
                                          u::Ptr{Cfloat}, ldu::Int64, vt::Ptr{Cfloat},
                                          ldvt::Int64, scratchpad::Ptr{Cfloat},
                                          scratchpad_size::Int64)::Cint
end

function onemklSgesvda_batch_scratchpad_size(device_queue, m, n, lda, stride_a, stride_s,
                                             ldu, stride_u, ldvt, stride_vt, batch_size)
    @ccall liboneapi_support.onemklSgesvda_batch_scratchpad_size(device_queue::syclQueue_t,
                                                                 m::Int64, n::Int64,
                                                                 lda::Int64,
                                                                 stride_a::Int64,
                                                                 stride_s::Int64,
...
function onemklDgesvda_batch_scratchpad_size(device_queue, m, n, lda, stride_a, stride_s,
                                             ldu, stride_u, ldvt, stride_vt, batch_size)
    @ccall liboneapi_support.onemklDgesvda_batch_scratchpad_size(device_queue::syclQueue_t,
                                                                 m::Int64, n::Int64,
                                                                 lda::Int64,
                                                                 stride_a::Int64,
                                                                 stride_s::Int64,
...
function onemklCgesvda_batch_scratchpad_size(device_queue, m, n, lda, stride_a, stride_s,
                                             ldu, stride_u, ldvt, stride_vt, batch_size)
    @ccall liboneapi_support.onemklCgesvda_batch_scratchpad_size(device_queue::syclQueue_t,
                                                                 m::Int64, n::Int64,
                                                                 lda::Int64,
                                                                 stride_a::Int64,
                                                                 stride_s::Int64,
...
function onemklZgesvda_batch_scratchpad_size(device_queue, m, n, lda, stride_a, stride_s,
                                             ldu, stride_u, ldvt, stride_vt, batch_size)
    @ccall liboneapi_support.onemklZgesvda_batch_scratchpad_size(device_queue::syclQueue_t,
                                                                 m::Int64, n::Int64,
                                                                 lda::Int64,
                                                                 stride_a::Int64,
                                                                 stride_s::Int64,
...
function onemklCgesvda_batch(device_queue, iparm, irank, m, n, a, lda, stride_a, s,
                             stride_s, u, ldu, stride_u, vt, ldvt, stride_vt, tolerance,
                             residual, batch_size, scratchpad, scratchpad_size)
    @ccall liboneapi_support.onemklCgesvda_batch(device_queue::syclQueue_t,
                                                 iparm::Ptr{Int64}, irank::Ptr{Int64},
                                                 m::Int64, n::Int64, a::Ptr{ComplexF32},
                                                 lda::Int64, stride_a::Int64,
                                                 s::Ptr{Cfloat}, stride_s::Int64,
                                                 u::Ptr{ComplexF32}, ldu::Int64,
                                                 stride_u::Int64, vt::Ptr{ComplexF32},
                                                 ldvt::Int64, stride_vt::Int64,
                                                 tolerance::Cfloat, residual::Ptr{Cfloat},
                                                 batch_size::Int64,
                                                 scratchpad::Ptr{ComplexF32},
                                                 scratchpad_size::Int64)::Cint
end

function onemklDgesvda_batch(device_queue, iparm, irank, m, n, a, lda, stride_a, s,
                             stride_s, u, ldu, stride_u, vt, ldvt, stride_vt, tolerance,
                             residual, batch_size, scratchpad, scratchpad_size)
    @ccall liboneapi_support.onemklDgesvda_batch(device_queue::syclQueue_t,
                                                 iparm::Ptr{Int64}, irank::Ptr{Int64},
                                                 m::Int64, n::Int64, a::Ptr{Cdouble},
                                                 lda::Int64, stride_a::Int64,
                                                 s::Ptr{Cdouble}, stride_s::Int64,
                                                 u::Ptr{Cdouble}, ldu::Int64,
                                                 stride_u::Int64, vt::Ptr{Cdouble},
                                                 ldvt::Int64, stride_vt::Int64,
                                                 tolerance::Cdouble, residual::Ptr{Cdouble},
                                                 batch_size::Int64,
                                                 scratchpad::Ptr{Cdouble},
                                                 scratchpad_size::Int64)::Cint
end

function onemklSgesvda_batch(device_queue, iparm, irank, m, n, a, lda, stride_a, s,
                             stride_s, u, ldu, stride_u, vt, ldvt, stride_vt, tolerance,
                             residual, batch_size, scratchpad, scratchpad_size)
    @ccall liboneapi_support.onemklSgesvda_batch(device_queue::syclQueue_t,
                                                 iparm::Ptr{Int64}, irank::Ptr{Int64},
                                                 m::Int64, n::Int64, a::Ptr{Cfloat},
                                                 lda::Int64, stride_a::Int64,
                                                 s::Ptr{Cfloat}, stride_s::Int64,
...
function onemklZgesvda_batch(device_queue, iparm, irank, m, n, a, lda, stride_a, s,
                             stride_s, u, ldu, stride_u, vt, ldvt, stride_vt, tolerance,
                             residual, batch_size, scratchpad, scratchpad_size)
    @ccall liboneapi_support.onemklZgesvda_batch(device_queue::syclQueue_t,
                                                 iparm::Ptr{Int64}, irank::Ptr{Int64},
                                                 m::Int64, n::Int64, a::Ptr{ComplexF32},
                                                 lda::Int64, stride_a::Int64,
                                                 s::Ptr{Cdouble}, stride_s::Int64,
...
function onemklDgetrs(device_queue, trans, n, nrhs, a, lda, ipiv, b, ldb, scratchpad,
    ...
    @ccall liboneapi_support.onemklDgetrs(device_queue::syclQueue_t, trans::onemklTranspose,
                                          n::Int64, nrhs::Int64, a::Ptr{Cdouble},
                                          lda::Int64, ipiv::Ptr{Int64}, b::Ptr{Cdouble},
                                          ldb::Int64, scratchpad::Ptr{Cdouble},
                                          scratchpad_size::Int64)::Cint
end
...
function onemklSgetrs(device_queue, trans, n, nrhs, a, lda, ipiv, b, ldb, scratchpad,
    ...
    @ccall liboneapi_support.onemklSgetrs(device_queue::syclQueue_t, trans::onemklTranspose,
                                          n::Int64, nrhs::Int64, a::Ptr{Cfloat}, lda::Int64,
                                          ipiv::Ptr{Int64}, b::Ptr{Cfloat}, ldb::Int64,
                                          scratchpad::Ptr{Cfloat},
                                          scratchpad_size::Int64)::Cint
end
...
function onemklSsytrf(device_queue, uplo, n, a, lda, ipiv, scratchpad, scratchpad_size)
    @ccall liboneapi_support.onemklSsytrf(device_queue::syclQueue_t, uplo::onemklUplo,
                                          n::Int64, a::Ptr{Cfloat}, lda::Int64,
                                          ipiv::Ptr{Int64}, scratchpad::Ptr{Cfloat},
                                          scratchpad_size::Int64)::Cint
end
...
function onemklDsytrf(device_queue, uplo, n, a, lda, ipiv, scratchpad, scratchpad_size)
    @ccall liboneapi_support.onemklDsytrf(device_queue::syclQueue_t, uplo::onemklUplo,
                                          n::Int64, a::Ptr{Cdouble}, lda::Int64,
                                          ipiv::Ptr{Int64}, scratchpad::Ptr{Cdouble},
                                          scratchpad_size::Int64)::Cint
end
...
function onemklSgeqrf_batch(device_queue, m, n, a, lda, stride_a, tau, stride_tau,
    ...
    @ccall liboneapi_support.onemklSgeqrf_batch(device_queue::syclQueue_t, m::Int64,
                                                n::Int64, a::Ptr{Cfloat}, lda::Int64,
                                                stride_a::Int64, tau::Ptr{Cfloat},
                                                stride_tau::Int64, batch_size::Int64,
                                                scratchpad::Ptr{Cfloat},
                                                scratchpad_size::Int64)::Cint
end
...
function onemklDgeqrf_batch(device_queue, m, n, a, lda, stride_a, tau, stride_tau,
    ...
    @ccall liboneapi_support.onemklDgeqrf_batch(device_queue::syclQueue_t, m::Int64,
                                                n::Int64, a::Ptr{Cdouble}, lda::Int64,
                                                stride_a::Int64, tau::Ptr{Cdouble},
                                                stride_tau::Int64, batch_size::Int64,
                                                scratchpad::Ptr{Cdouble},
                                                scratchpad_size::Int64)::Cint
end
...
function onemklCgeqrf_batch(device_queue, m, n, a, lda, stride_a, tau, stride_tau,
    ...
    @ccall liboneapi_support.onemklCgeqrf_batch(device_queue::syclQueue_t, m::Int64,
                                                n::Int64, a::Ptr{ComplexF32}, lda::Int64,
                                                stride_a::Int64, tau::Ptr{ComplexF32},
                                                stride_tau::Int64, batch_size::Int64,
                                                scratchpad::Ptr{ComplexF32},
                                                scratchpad_size::Int64)::Cint
end
...
function onemklCungqr_batch(device_queue, m, n, k, a, lda, stride_a, tau, stride_tau,
    ...
    @ccall liboneapi_support.onemklCungqr_batch(device_queue::syclQueue_t, m::Int64,
                                                n::Int64, k::Int64, a::Ptr{ComplexF32},
                                                lda::Int64, stride_a::Int64,
...
function onemklSsparse_trsv(device_queue, uplo_flag, transpose_flag, diag_val, alpha,
                            handle, x, y)
    @ccall liboneapi_support.onemklSsparse_trsv(device_queue::syclQueue_t,
                                                uplo_flag::onemklUplo,
                                                transpose_flag::onemklTranspose,
                                                diag_val::onemklDiag, alpha::Cfloat,
                                                handle::ZePtr{Cfloat}, x::ZePtr{Cfloat},
                                                y::Ptr{Cfloat})::Cint
end

function onemklDsparse_trsv(device_queue, uplo_flag, transpose_flag, diag_val, alpha,
                            handle, x, y)
    @ccall liboneapi_support.onemklDsparse_trsv(device_queue::syclQueue_t,
                                                uplo_flag::onemklUplo,
                                                transpose_flag::onemklTranspose,
                                                diag_val::onemklDiag, alpha::Cdouble,
                                                handle::ZePtr{Cdouble}, x::ZePtr{Cdouble},
                                                y::Ptr{Cdouble})::Cint
end

function onemklCsparse_trsv(device_queue, uplo_flag, transpose_flag, diag_val, alpha,
                            handle, x, y)
    @ccall liboneapi_support.onemklCsparse_trsv(device_queue::syclQueue_t,
                                                uplo_flag::onemklUplo,
                                                transpose_flag::onemklTranspose,
                                                diag_val::onemklDiag, alpha::ComplexF32,
                                                handle::ZePtr{ComplexF32},
                                                x::ZePtr{ComplexF32},
                                                y::Ptr{ComplexF32})::Cint
end

function onemklZsparse_trsv(device_queue, uplo_flag, transpose_flag, diag_val, alpha,
                            handle, x, y)
    @ccall liboneapi_support.onemklZsparse_trsv(device_queue::syclQueue_t,
                                                uplo_flag::onemklUplo,
                                                transpose_flag::onemklTranspose,
                                                diag_val::onemklDiag, alpha::ComplexF32,
                                                handle::ZePtr{ComplexF64},
                                                x::ZePtr{ComplexF64},
                                                y::Ptr{ComplexF32})::Cint
end
